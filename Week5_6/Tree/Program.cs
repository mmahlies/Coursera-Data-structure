...
namespace Week5_6
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Tree.AVLInsert(4, root);
            Tree.AVLInsert(11, root);
            Tree.AVLInsert(12, root);
            Tree.AVLInsert(13, root);

            Node root2 = new Node(100);
            Tree.AVLInsert(101, root2);
            Tree.AVLInsert(102, root2);
            Tree.AVLInsert(103, root2);
            Tree.AVLInsert(80, root2);
            Tree.AVLInsert(90, root2);
         Node r =    Tree.Merge(root, root2);
    ...
    abstract class Tree
    {
        ...
        /// <summary>
        ///  Delete node n and fill RepalanceNode
        /// </summary>
        /// <param name="n"></param>
        ...
        /// <summary>
        ///  promote node by making it's parent is it's grand father
        /// </summary>
...
#warning need to adjust height if needed
        ...
        public static KeyValuePair<Node,Node> Split(Node root, int x)
        {
            ...
            if (x < root.key)
            {
                spilitedTree = Split(root.LeftNode, x);
                Node r3 = AVLTreeMWR(spilitedTree.Value, root.RightNode, root);
                return new KeyValuePair<Node, Node>(spilitedTree.Key, r3);
            }
            else
            {
                spilitedTree = Split(root.RightNode, x);
                Node r3 = AVLTreeMWR(root.LeftNode, spilitedTree.Key, root);
